...
Config.Locations = { -- Edit the various interaction points for players or create new ones
    ["checking"] = {
	    [1] = vector3(307.08, -595.12, 43.28),
	    [2] = vector3(-254.54, 6331.78, 32.43), -- paleto
    },
    ["duty"] = {
        [1] = vector3(310.71, -597.17, 43.28), --city
        [2] = vector3(-254.88, 6324.5, 32.58),
    },
    ["vehicle"] = {
        [1] = vector4(292.22, -583.3, 43.19, 344.48), --city
        [2] = vector4(-234.28, 6329.16, 32.15, 222.5),
    },
    ["helicopter"] = {
        [1] = vector4(352.5, -587.9, 74.16, 151.45),     --city
        [2] = vector4(-475.43, 5988.353, 31.716, 31.34),
    },
    ["armory"] = {
        [1] = vector3(306.89, -601.86, 43.28), --city
    ...
    ["main"] = {
        [1] = vector3(326.92, -603.71, 43.28),
    },
    ["stash"] = {
        [1] = vector3(309.86, -569.03, 43.28),
    },
    ["beds"] = {
        [1] = {coords = vector4(313.96, -578.97, 44.2, 159.0), taken = false, model = 1631638868},
        [2] = {coords = vector4(309.24, -577.4, 44.2, 160.74), taken = false, model = 1631638868},
        [3] = {coords = vector4(307.73, -581.67, 44.2, 341.39), taken = false, model = 1631638868},
        [4] = {coords = vector4(311.13, -582.95, 44.2, 339.68), taken = false, model = 1631638868},
        [5] = {coords = vector4(314.64, -584.04, 44.2, 339.94), taken = false, model = 1631638868},
        [6] = {coords = vector4(317.76, -585.32, 44.2, 344.83), taken = false, model = -1631638868},
        [7] = {coords = vector4(322.59, -587.17, 44.2, 342.17), taken = false, model = -1631638868},
        [8] = {coords = vector4(319.36, -580.97, 44.2, 156.48), taken = false, model = -1631638868},
        [9] = {coords = vector4(324.31, -582.64, 44.2, 161.54), taken = false, model = -1631638868},
	--- paleto
